...
class Recycler_SelectCoupon_Adapet(var list: ArrayList<SelectCoupon_DataModel>, var context: Context, var clickSelectCoupon: ClickSelectCoupon):RecyclerView.Adapter<Recycler_SelectCoupon_Adapet.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.text_brandName_selectCoupon.text = list.get(position).brand_name
         ...
         if (list[position].saved_coupon == "unsaved"){
             holder.img_savedClick.visibility = GONE
             holder.img_savedUnclick.visibility = VISIBLE
         }else{
             holder.img_savedClick.visibility = VISIBLE
             holder.img_savedUnclick.visibility = GONE
         }
