...
class Recycler_TrandingCoupon_Adapter(var list: ArrayList<TrandingCoupon_DataModel>, var context: Context, var trandCoupon:TrandCoupon):RecyclerView.Adapter<Recycler_TrandingCoupon_Adapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.const_trandingCoupon.setOnClickListener(View.OnClickListener {
            trandCoupon.trandClick(position)
        })
    ...
    interface TrandCoupon{
        fun trandClick(position: Int)
    }
